...
if("TRUE" STREQUAL "TRUE")
  set(robot_sim_SOURCE_PREFIX /home/jesse/ros_sandbox/hw2/src/robot_sim)
  set(robot_sim_DEVEL_PREFIX /home/jesse/ros_sandbox/hw2/devel)
  ...
  set(robot_sim_INSTALL_PREFIX /home/jesse/ros_sandbox/hw2/install)
...
if(NOT "/home/jesse/ros_sandbox/hw2/src/robot_sim/include " STREQUAL " ")
  set(robot_sim_INCLUDE_DIRS "")
  set(_include_dirs "/home/jesse/ros_sandbox/hw2/src/robot_sim/include")
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'robot_sim' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/jesse/ros_sandbox/hw2/src/robot_sim/${idir}'.  Ask the maintainer 'matei <matei@todo.todo>' to fix it.")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/jesse/ros_sandbox/hw2/devel/lib;/opt/ros/indigo/lib)
