...
bool JointStatePublisher::init()
{
  ...
  state_publisher_ = root_nh_.advertise<sensor_msgs::JointState>("robot/joint_states", 10);
  state_timer_ = root_nh_.createTimer(ros::Duration(0.01), &JointStatePublisher::callback, this);
